...
if ($section == 'comments') {
    require_once "../app/pages/admin/manager-comments.php";
    ...
    <span class="hidden md:block mt-[10%]">Mr Diaa</span>
        ...
        <div class="flex justify-between items-center h-14 bg-[#E8F3F3] text-sm  font-bold  dark:bg-gray-800 header-right">
          ...
          <ul class="flex items-center">
            ...
            <li>
              <a href="?logout" class="flex items-center mr-4 hover:text-[#00AAA1]">
        ...
        <div class="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
          <ul class="flex flex-col py-4 space-y-1">
            <li class="px-5 hidden md:block">
              <div class="flex flex-row items-center h-8 border-b-[2px] ">
              
              </div>
            </li>
            <li>
              <a   <?php $section =='dashboard' ? 'active':''?>        href="<?=ROOT?>/admin" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-[#00AAA1] dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
            ...
            <li>
              <a        <?=$section =='categories' ? 'active':''?>      href="<?=ROOT?>/admin/comments" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-[#00AAA1] dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
                <span class="inline-flex justify-center items-center ml-4">
            ...
            <li>
              <a href="<?=ROOT?>/admin/subsriptions" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-[#00AAA1] dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
                <span class="inline-flex justify-center items-center ml-4">
            ...
            <li>
              <a <?=$section =='profile' ? 'active':''?>  href="<?=ROOT?>/admin/profile" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-[#00AAA1] dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
                <span class="inline-flex justify-center items-center ml-4">
            ...
            <li>
              <a <?=$section =='settings' ? 'active':''?>  href="<?=ROOT?>/admin/settings" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-[#00AAA1] dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
                <span class="inline-flex justify-center items-center ml-4">
